...
if (anchorType == 0) || (anchorType == 1)
    %gridForAnchors = power(noOfAnchors,1/sDim);
    gridForAnchors = round(power(noOfAnchors,1/sDim));
    if noOfAnchors == 1
        noOfAnchors = 1;
        ...
        if sDim == 2
          ...
          % anchorMatrix= [0.95 0.95 0.05  0.05; 0.95 0.05 0.95 0.05];
          % anchorMatrix= [0.7 0.7 0.3 0.3; 0.7 0.3 0.7 0.3];
        elseif sDim == 3
            for i = 1:gridForAnchors
                for j=1:gridForAnchors
        ...
        %anchorMatrix(1,:) =[0 1 0 1];
        %anchorMatrix(2,:) =[0 0 1 1];
...
elseif anchorType == 3
    ...
    xMatrix0 = [xMatrix0(:,1:noOfSensors), anchorMatrix];
    %xMatrix0(1:2,noOfSensors+1:end) =[0.2 0.5 0.8;0.2 0.8 0.4];
% <--- placing anchors on the coordinate axes
